...
require __DIR__.'/../app/Modules/Documentos/Http/Routes/api.php';
require __DIR__.'/../app/Modules/Familias/Http/Routes/api.php';
require __DIR__.'/../app/Modules/UnidadesMedida/Http/Routes/api.php';
require __DIR__.'/../app/Modules/TiposUnidadMedida/Http/Routes/api.php';
require __DIR__.'/../app/Modules/UnidadesMedida/Http/Routes/api.php';
require __DIR__.'/../app/Modules/ProductoConversiones/Http/Routes/api.php';
